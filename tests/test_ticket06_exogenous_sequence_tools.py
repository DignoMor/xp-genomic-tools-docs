...
REFERENCE = ROOT / "docs/reference/cli/exogenous-sequence-tools"


class Ticket06ExogenousSequenceToolsReferenceTest(unittest.TestCase):
    ...
    def test_semantic_reference_links_reusable_formats(self) -> None:
        root = ROOT / "docs/reference/cli/exogenous-sequence-tools"
        ...
        for page in ("exogenous-fasta.md", "assembly-outputs.md",
            ...
            self.assertTrue((ROOT / "docs/reference/formats/cli/exogenous-sequence-tools" / page).is_file())
    ...
    def test_built_artifact_has_complete_cli_and_format_pages(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            cli_html = html.unescape((site / "reference/cli/exogenous-sequence-tools/index.html").read_text())
