...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `-h, --help` | `-h`, `--help` | no | `0` | `inapplicable` | inapplicable | `inapplicable` | no | show this help message and exit |
| `--barcode_length` | `--barcode_length` | yes | `none` | `int` | inapplicable | `none` | no |  |
| `--alphabet` | `--alphabet` | no | `none` | `inapplicable` | inapplicable | `ACGT` | no |  |
| `--motif_file` | `--motif_file` | no | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--exclude` | `--exclude` | no | `none` | `inapplicable` | inapplicable | `none` | yes |  |
| `--max_candidates` | `--max_candidates` | no | `none` | `int` | inapplicable | `1000000` | no |  |
| `--output` | `--output` | yes | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--force` | `--force` | no | `0` | `inapplicable` | inapplicable | `False` | no |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `-h, --help` | `-h`, `--help` | no | `0` | `inapplicable` | inapplicable | `inapplicable` | no | show this help message and exit |
| `--motif_file` | `--motif_file` | yes | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--motif_name` | `--motif_name` | yes | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--num_sequences` | `--num_sequences` | yes | `none` | `int` | inapplicable | `none` | no |  |
| `--seed` | `--seed` | no | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--output` | `--output` | yes | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--force` | `--force` | no | `0` | `inapplicable` | inapplicable | `False` | no |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `-h, --help` | `-h`, `--help` | no | `0` | `inapplicable` | inapplicable | `inapplicable` | no | show this help message and exit |
| `--sequence_length` | `--sequence_length` | yes | `none` | `int` | inapplicable | `none` | no |  |
| `--num_sequences` | `--num_sequences` | yes | `none` | `int` | inapplicable | `none` | no |  |
| `--alphabet` | `--alphabet` | no | `none` | `inapplicable` | inapplicable | `ACGT` | no |  |
| `--motif_file` | `--motif_file` | no | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--exclude` | `--exclude` | no | `none` | `inapplicable` | inapplicable | `none` | yes |  |
| `--seed` | `--seed` | no | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--max_attempts` | `--max_attempts` | no | `none` | `int` | inapplicable | `10000` | no |  |
| `--output` | `--output` | yes | `none` | `inapplicable` | inapplicable | `none` | no |  |
| `--force` | `--force` | no | `0` | `inapplicable` | inapplicable | `False` | no |  |
