...
| `--motif_file` | `--motif_file` | no | `none` | `inapplicable` | inapplicable | `none` | no | MEME motif collection for exclusions (not yet delivered). |
| `--exclude` | `--exclude` | no | `none` | `inapplicable` | inapplicable | `none` | yes | Motif exclusion MOTIF=CUTOFF (not yet delivered). |
| `--seed` | `--seed` | no | `none` | `int` | inapplicable | `none` | no | Deterministic random seed (0 is valid). |
