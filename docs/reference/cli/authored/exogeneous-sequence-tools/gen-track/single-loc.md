# `ExogeneousSequenceTools gen_track single_loc`
...
Run `ExogeneousSequenceTools gen_track single_loc --help` after installation to inspect required flags, then supply tiny synthetic inputs aligned with the linked format pages.
