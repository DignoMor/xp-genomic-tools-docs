# `ExogeneousSequenceTools print_stat`
...
Run `ExogeneousSequenceTools print_stat --help` after installation to inspect required flags, then supply tiny synthetic inputs aligned with the linked format pages.
