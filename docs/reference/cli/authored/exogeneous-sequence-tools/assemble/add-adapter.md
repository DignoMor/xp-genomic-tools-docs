...
Run `ExogeneousSequenceTools assemble add_adapter --help` after installation to inspect required flags, then supply tiny synthetic inputs aligned with the linked format pages.
