...
Run `GenomicElementTools export ExogeneousSequences --help` after installation to inspect required flags, then supply tiny synthetic inputs aligned with the linked format pages.
