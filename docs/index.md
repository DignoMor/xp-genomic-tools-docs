...
This site documents release **0.2.0a1**.
...
!!! warning "Alpha release"
    **0.2.0a1** is a pre-release. APIs and CLI flags may change. Pin the tag if
...
1. [Install](install.md) from the `0.2.0a1` code tag
...
Code repository: [DignoMor/xp-genomic-tools](https://github.com/DignoMor/xp-genomic-tools) (tag `0.2.0a1`).
