...
This site documents release **0.2.0a2**.

## What ships in 0.2.0a2

| Component | Kind | Role |
| --- | --- | --- |
| `RGTools` | Python library | Regions, FASTA, motifs, BigWig tracks, annotations |
| `GenomicElementTools` | CLI | Region transforms, signal counting, motifs, import/export, masks |
...
!!! warning "Alpha release"
    **0.2.0a2** is a pre-release. APIs and CLI flags may change. Pin the tag if
...
1. [Install](install.md) from the `0.2.0a2` code tag
...
Code repository: [DignoMor/xp-genomic-tools](https://github.com/DignoMor/xp-genomic-tools) (tag `0.2.0a2`).
